<template>
  <div class="yibao-refund-record-wrapper">
    <Card style="width:100%;">
      <div slot="title"
           class="search-title-wrapper">
        <span class="title">医保退费记录</span>
      ...
      <div class="page-body clearfix">
        ...
        <div class="table-wrapper">
          <vxe-table class="mytable-footer"
            ...
            <vxe-table-column field="syb"
                              title="市医保"
                              min-width="120">
              <template v-slot="{row}">
                <span>{{row.syb ? row.syb : ''}}</span>
              </template>
            </vxe-table-column>
            <vxe-table-column field="qyb"
                              title="区医保"
                              min-width="120">
              <template v-slot="{row}">
                <span>{{row.qyb ? row.qyb : ''}}</span>
              </template>
            </vxe-table-column>
          </vxe-table>
          <vxe-table class="mytable-footer"
