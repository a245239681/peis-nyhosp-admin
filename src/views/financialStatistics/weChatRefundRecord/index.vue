<template>
  <div class="wechat-refund-record-wrapper">
    <Card style="width:100%;">
      <div slot="title"
           class="search-title-wrapper">
        <span class="title">小程序退费记录</span>
      ...
      <div class="page-body clearfix">
            ...
            <Form :model="form"
              ...
              <FormItem label="退费日期"
                ...
                <DatePicker type="date"
                            style="width:140px"
                            v-model="form.wxRefundDateStart"
              ...
              <FormItem label="到"
                ...
                <DatePicker type="date"
                            style="width:140px"
                            v-model="form.wxRefundDateEnd"
                            size="small"></DatePicker>
              </FormItem>
              <FormItem label="交易退费单号"
                        :label-width="105">
                <Input v-model="form.wxRefundId"
                       style="width:135px"
                       size="small"
                       clearable />
              </FormItem>
        ...
        <div class="table-wrapper">
          ...
          <vxe-table class="mytable-footer"
            ...
            <vxe-table-column field="wxRefundId"
                              min-width="140"
                              title="交易退费单号"></vxe-table-column>
            <vxe-table-column field="refundPriceStr"
                              width="120"
            ...
            <vxe-table-column field="wxRefundDate"
                              title="退费时间"
                              min-width="160"></vxe-table-column>
...
import { wechatRefundRecord, refundRecordLeadout } from '@/api/weChatRefundRecord'
import moment from 'moment'

export default {
  name: 'weChatRefundRecord',
  data () {
    return {
  ...
  mounted () {
    ...
    this.$set(this.form, 'wxRefundDateStart', curDate)
    this.$set(this.form, 'wxRefundDateEnd', curDate)
    this.getList()
  },
  methods: {
    // 获取退费记录列表
    getList (page = 1, size = 20) {
      ...
      // 格式化时间
      let _wxRefundDateStart = this.form.wxRefundDateStart != '' ? moment(this.form.wxRefundDateStart).format('YYYY-MM-DD') : ''
      let _wxRefundDateEnd = this.form.wxRefundDateEnd != '' ? moment(this.form.wxRefundDateEnd).format('YYYY-MM-DD') : ''
      const params = Object.assign({}, this.form)
      params.wxRefundDateStart = _wxRefundDateStart
      params.wxRefundDateEnd = _wxRefundDateEnd
      this.isLoading = true
      wechatRefundRecord(pagination, params).then(({ data }) => {
