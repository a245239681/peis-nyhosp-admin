    ...
    <Card style="width:100%;">
      ...
      <div class="page-body clearfix">
        <Table :columns="columns"
          ...
          <template slot="sdContent"
                    slot-scope="{row}">
            <span v-if="row.sdContent == '0'">是</span>
            <span v-else>否</span>
          </template>
...
<script>
import { settingList, settingDelete } from '@/api/system_setting.js'
...
export default {
  ...
  methods: {
    getList (page = 1, size = 20) {
      ...
      this.isLoading = true
      settingList(pagination, params).then(({ data }) => {
