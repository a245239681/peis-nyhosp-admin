    ...
    <div class="info-container">
            ...
            <Row>
              ...
              >
                ...
                >
                  ...
                  <Option value="7">已初步审核</Option>
                  <Option value="9">已最终审核</Option>
                </Select>
              </FormItem>
              </Col>
              <Col
      ...
      >
        <div class="block-color">
          ...
          <!-- <div class="block-item">已初步审核:<span style="background-color: #cffef4;"></span></div>
        ...
        <div class="table-wrapper">
          ...
          >
            <template
              ...
              slot-scope="{row}"
            >{{row.boActualRegisterDate | dateTime}}</template>
          </Table>
        </div>
...
import { getPatientList } from "@/api/personBalace.js";
...
export default {
  ...
  methods: {
    ...
    //   console.log(this.UnitList, 123456789)
