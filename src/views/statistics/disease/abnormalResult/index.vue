<template>
  <div class="abnormal-result-page-wrapper">
    <Card style="width:100%;">
      <div slot="title"
           class="search-title-wrapper">
        <span class="title">阳性结果汇总</span>
      </div>
      <div class="page-body clearfix">
        ...
        <div class="table-wrapper">
          ...
          <vxe-table class="mytable-footer"
                     ...
                     :height="(screenHeight - 420) <= 350 ? 350 : (screenHeight - 420)"
                     :data="tableData"
                     :loading="isLoading">
            ...
            <vxe-table-column field="boGroupName"
                              ...
                              show-overflow="title"
                              min-width="120"></vxe-table-column>
            <vxe-table-column field="itemResults"
                              title="阳性结果"
                              show-overflow="ellipsis"
                              min-width="160">
            </vxe-table-column>
            <vxe-table-column field="examTime"
                              title="体检日期"
                              width="160"
...
import { unitGroupInfo, abnormalResultList, abnormalResultLeadout } from '@/api/workload'
...
export default {
  ...
  methods: {
    ...
    getList (page = 1, size = 20) {
      ...
      this.isLoading = true
      abnormalResultList(pagination, params).then(({ data }) => {
    ...
    async leadoutExcelHandle () {
      ...
      try {
        const { data } = await abnormalResultLeadout(params)
        this.leadoutLoading = false
        let blob = new Blob([data], { type: 'application/vnd.ms-excel' })
        let link = document.createElement('a')
        link.href = window.URL.createObjectURL(blob)
        link.download = '阳性结果统计.xlsx'
        link.click()
